...
import { Home, LayoutDashboard, User, Settings, RotateCw, Shield, Activity, Receipt, LogOut, Menu, X, Server } from 'lucide-react'
    ...
    <>
      ...
      {open && (
        <>
          ...
          {/* Menu panel */}
          <div className="absolute top-full right-0 mt-2 w-56 bg-[#16171d]/95 backdrop-blur-xl border border-white/10 rounded-2xl p-2 shadow-2xl z-50 space-y-0.5">
